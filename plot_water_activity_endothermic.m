...
print('Activity_Coefficient_vs_Mole_Fraction_New', '-dpng', '-r600')
...
fig.PaperUnits = 'inches';
fig.PaperPosition = [0 0 9 7]; 
print('Activity_Coefficient_vs_RH_New', '-dpng', '-r600')

disp('Plots generated successfully!')
disp('  - Activity_Coefficient_vs_Mole_Fraction_New.png')
disp('  - Activity_Coefficient_vs_RH_New.png')