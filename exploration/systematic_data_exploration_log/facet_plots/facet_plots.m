...
output_filename = fullfile(filepath, 'systematic_exploration_results_log.txt');
...
sgtitle('ln(a_w) vs Ionic Strength - Faceted by Anion (colored by cation radius)', ...
...
sgtitle('ln(a_w) vs Ionic Strength - Faceted by Cation (colored by anion radius)', ...
        'FontSize', 14, 'FontWeight', 'bold');
...
sgtitle('ln(a_w) vs Mole Fraction Water - Faceted by Anion (colored by cation radius)', ...
        'FontSize', 14, 'FontWeight', 'bold');
...
sgtitle('ln(a_w) vs Mole Fraction Water - Faceted by Cation (colored by anion radius)', ...
        'FontSize', 14, 'FontWeight', 'bold');
...
sgtitle('ln(\gamma_w) vs Ionic Strength - Faceted by Anion (colored by cation radius)', ...
        'FontSize', 14, 'FontWeight', 'bold');
...
sgtitle('ln(\gamma_w) vs Ionic Strength - Faceted by Cation (colored by anion radius)', ...
        'FontSize', 14, 'FontWeight', 'bold');
...
sgtitle('ln(\gamma_w) vs Mole Fraction Water - Faceted by Anion (colored by cation radius)', ...
        'FontSize', 14, 'FontWeight', 'bold');
...
sgtitle('ln(\gamma_w) vs Mole Fraction Water - Faceted by Cation (colored by anion radius)', ...
        'FontSize', 14, 'FontWeight', 'bold');
...
sgtitle('ln(\gamma_w) vs RH - Faceted by Anion (colored by cation radius)', ...
        'FontSize', 14, 'FontWeight', 'bold');
...
sgtitle('ln(\gamma_w) vs RH - Faceted by Cation (colored by anion radius)', ...
        'FontSize', 14, 'FontWeight', 'bold');
