...
salt_data = {
    ...
    {'MgNO32', 148.3, 0.55, 0.9, 'calculate_mf_MgNO3', 0, 1, 2, 25, 3, 3, 1, 2};  % Alias for plot scripts
    ...
    % Nitrates (additional)
    {'NH4NO3', 80.043, 0.118, 0.732, 'calculate_mf_NH4NO3', 0, 1, 1, 25, 2, 1, 1, 1};
    ...
    % Halides (additional)
    {'CaBr2', 199.89, 0.6405, 0.9530, 'calculate_mf_CaBr2', 0, 1, 2, 30, 3, 3, 1, 2};
    ...
    {'SrBr2', 247.43, 0.7786, 0.9561, 'calculate_mf_SrBr2', 0, 1, 2, 30, 3, 3, 1, 2};
    {'SrI2', 341.43, 0.6795, 0.9559, 'calculate_mf_SrI2', 0, 1, 2, 30, 3, 3, 1, 2};
    {'BaCl2', 208.23, 0.9385, 0.9721, 'calculate_mf_BaCl2', 0, 1, 2, 30, 3, 3, 1, 2};
    {'BaBr2', 297.14, 0.8231, 0.9577, 'calculate_mf_BaBr2', 0, 1, 2, 30, 3, 3, 1, 2};
