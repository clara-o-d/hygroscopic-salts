...
0.402702276	0.912445671
    ...
    solutes(i).degree = standard_degree;
    solutes(i).data = [
0.167422467	0.95397345
0.198373545	0.940721384
0.25462802	0.913461087
0.310607301	0.870341067
0.376584869	0.799079018
0.402923991	0.764284644
0.441142719	0.705684065
0.47881227	0.639481351
    ];
    ...
    solutes(i).degree = standard_degree;
    solutes(i).data = [
0.250619423	0.952379271
0.300816803	0.936192589
0.355265067	0.911602817
0.400475749	0.893136984
0.461398483	0.832105775
    ];
    ...
    solutes(i).degree = standard_degree;
    solutes(i).data = [
0.094979102	0.977829006
0.121326862	0.974595251
0.170764795	0.948931501
0.19242207	0.931518107
0.22171624	0.916305117
0.259712693	0.895091438
0.299190497	0.861205225
0.33676957	0.805894113
    ];
    ...
    solutes(i).degree = standard_degree;
    solutes(i).data = [
0.165236438	0.957133953
0.200413604	0.954008853
0.249696136	0.942592822
0.30168221	0.918003281
0.330597835	0.895163358
0.372093913	0.869539925
0.396563094	0.840963526
0.45247967	0.777627364
    ];
    ...
    solutes(i).degree = standard_degree;
    solutes(i).data = [
0.248790797	0.956920169
0.301465012	0.939514862
0.343725923	0.924518298
0.400911621	0.893160797
0.447266181	0.858260051
0.500353298	0.812920207
0.545621697	0.75097873
0.586603144	0.678532124
    ];
    ...
    solutes(i).degree = standard_degree;
    solutes(i).data = [
0.09497997	0.973129283
0.133203812	0.96679476
0.168761561	0.958721583
0.201782401	0.945965074
0.224218797	0.937525221
    ];
    ...
    solutes(i).degree = standard_degree;
    solutes(i).data = [
0.22924975	0.958681169
0.273193539	0.947207521
0.30038976	0.937481985
0.336395135	0.923202825
0.359385141	0.912879066
0.400148511	0.895104983
0.426520476	0.879802025
0.502408769	0.822106421
    ];
